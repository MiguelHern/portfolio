export const projects = [
  {
    ...
    technologies: ['JavaScript', 'Vue.js', 'Tailwind', 'C#', '.NET', 'MySQL'],

    myRole: {
      'Diseño de interfaz':
        'Trabajé en la creación del diseño visual, el flujo de la aplicación y la estructura de la interfaz utilizando Figma.',
      'Desarrollo FrontEnd':
        'Implementé las pantallas de la aplicación utilizando Vue 3 y Tailwind haciéndolas completamente responsivas para todos los dispositivos.',
      'Integración de funciones':
        'Desarrollé interfaces para la gestión de citas, calendario, gestión de usuarios, terapeutas y materiales, conectando el frontend con las funcionalidades del backend a través de APIs REST.',
