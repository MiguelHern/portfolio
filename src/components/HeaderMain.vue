<template>
  <nav
    class="fixed top-0 left-0 right-0 bg-white mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8 z-50"
    aria-label="Global"
  >
        ...
        <div class="-my-6 divide-y divide-gray-500/10">
          <div class="space-y-2 py-6">
            <div class="-mx-3">
              ...
              <!-- 'Proyectos ' sub-menu, show/hide based on menu state. -->
