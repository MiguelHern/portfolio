<template>
  <div class="overflow-hidden rounded-lg border border-gray-200 shadow-md">
    <div class="relative aspect-video group">
      <img :src="cover.url || '/placeholder.svg'" loading="lazy" :alt="title"
    ...
    <div class="p-4">
      ...
      <div class="flex flex-wrap gap-2">
        <span v-for="tag in tags" :key="tag"
          class="inline-flex items-center rounded-md bg-gray-200 px-2 py-1 text-xs font-medium ring-1 ring-inset ring-gray-500/10">
          {{ tag }}
        </span>
      </div>
    </div>
