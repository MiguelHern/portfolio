...
<template>
  <main>
    <section class="h-screen relative">
      <div class="absolute top-1/2 md:-translate-y-1/2 left-1/2 md:left-0 md:translate-x-0 -translate-x-1/2 flex flex-col items-center md:text-start text-center bg-white md:shadow-sm shadow-xl rounded-lg p-4">
        <div class="space-y-6">
      ...
      <div class="h-full -z-50">
        <iframe
          src="https://my.spline.design/robotfollowcursorforlandingpage-c350a36ea0746e001c43284802342ee2/"
          frameborder="0"
          width="100%"
          height="100%"
        ></iframe>
